...
const navbarLinks = [
  ...
  { label: "应用介绍", href: "/#features", ariaLabel: "Features" },
  { label: "软件价格", href: "/#pricing", ariaLabel: "Pricing" }, 
  { label: "联系我们", href: "/#feedback", ariaLabel: "Feedback" },
