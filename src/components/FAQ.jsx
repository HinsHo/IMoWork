...
const FAQData = [
  ...
  },
  {
    question: "为什么我的软件打不开?",
    answer:
      "软件需要使用授权来打开，你可以使用本软件的试用版本。",
  },
  {
    question: "如何设置软件的各个功能?",
    answer:
      "请详细参考软件使用视频或帮助文档中有关设置的说明部分。",
  },
  {
    question: "怎么查看软件的发行版本?",
    answer:
      "在软件的关于【发行历史】中，可以查看软件的发行版本。",
  },
];
    ...
    >
      <div className="relative z-10 container px-2 sm:px-8 lg:px-4 mx-auto w-11/12 sm:w-full">
        <div className="md:max-w-4xl mx-auto">
          {/* <p className="mb-7 block-subtitle text-center">你可能有些疑问?</p> */}
