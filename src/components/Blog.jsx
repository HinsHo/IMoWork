...
import blog1 from "../assets/images/CAM.jpg";
import blog2 from "../assets/images/machining.jpg";
...
const blogData = [
  {
    title: "CAM软件二次开发入门",
    subtitle:
      "学习如何使用CAM软件进行二次开发，掌握CAM软件的开发流程，熟练掌握CAM软件的开发工具，提升个人能力提升个人成长，提升个人竞争力。",
    image: blog1.src,
  },
  {
    title: "开发示例",
    subtitle: "通过本视频，查看我们已经研发的相关软件产品。",
    image: blog2.src,
  },
  {
    title: "教学文章",
    subtitle: "通过作者的博客文章，一步一步地学习CAM软件的二次开发。",
    image: blog3.src,
  },
];
      ...
      >
        <div className="container px-4 mb-20">
          <div className="max-w-2xl text-center lg:text-left mb-16 mx-auto lg:ml-0 lg:mr-0">
            <span className="block-subtitle">我的教程</span>
            <h2 className="mt-6 mb-6 text-4xl lg:text-5xl font-bold font-heading text-primaryText">
              与CAM编程相关的视频教程
            </h2>
            <p className="mb-6 text-secondaryText">
              了解我们在行业内的分享的相关视频教程，分享我们的见解和经验。
            </p>
          </div>
          <div className="flex 2xl:w-[1200px] lg:w-[1000px] xl:w-[1150px] flex-wrap -mx-4 items-start h-auto sm:h-[30rem] lg:h-[31rem]  xl:h-[35rem]">
            <div className="flex sm:hidden lg:flex w-11/12 mx-auto sm:ml-0 sm:mr-0 lg:w-1/2 xl:w-3/5 px-4 mb-8 lg:mb-0  h-full">             
              ...
              <a href="https://www.bilibili.com/video/BV1ww411x7Um/?spm_id_from=333.999.0.0" target="_blank"> 
                <div className="p-6 sm:p-10 bg-bgDark3 rounded-3xl h-full hover:bg-bgDark3Hover transition cursor-pointer">
                  <img
                    src={blogData[0].image}
                    alt={blogData[0].title}
            ...
            <div className="hidden sm:flex mx-auto lg:ml-0 lg:mr-0 w-1/12 sm:w-4/5 lg:w-1/2 xl:w-2/5 px-4  flex-col justify-between h-full">
